...
def run_twampy_command():
    ...
    # Display latencies in a QT-based GUI
    display_gui(rtt_values, outbound_values, inbound_values, results_folder, timestamp)
...
def display_gui(rtt_values, outbound_values, inbound_values, results_folder, timestamp):
    ...
    # Plot RTT values
    ax.plot(rtt_values, label='RTT (msec)')
    # Plot Outbound values
    ax.plot(outbound_values, label='Outbound (msec)')
    # Plot Inbound values
    ax.plot(inbound_values, label='Inbound (msec)')
    ...
    window.setWindowTitle("Latency Measurements")
    window.show()
    
    # Save the plot as PNG
    combined_png_file = os.path.join(results_folder, f"latencies_{timestamp}.png")
    figure.savefig(combined_png_file)
